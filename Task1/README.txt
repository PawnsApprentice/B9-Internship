...
- Compile the program using the following command: mingw32-make. This will generate an executable file called fib.exe.
- To run the program, type the following command: fib.exe.
